...
class DQN_Conv(nn.Module):
    ...
    def __init__(self, input_channels, nb_actions, nb_channels_one, nb_channels_two, nb_hidden):
        ...
        self.nb_channels_two = nb_channels_two
        self.conv1 = nn.Conv2d(2, nb_channels_one, kernel_size=(3,3))
        self.conv2 = nn.Conv2d(nb_channels_one, self.nb_channels_two, kernel_size=(3,3))
        self.fc1 = nn.Linear(self.nb_channels_two, nb_hidden)
